...
/*!****************************************************!*\
  ...
  \****************************************************/
/*! no static exports found */function(e,a,n){"use strict";var o=n(/*! moment */"./node_modules/moment/moment.js"),r=n(/*! ./socket_base */"./src/javascript/_common/base/socket_base.js"),t=n(/*! ../utility */"./src/javascript/_common/utility.js").PromiseClass,i=function(){var e=!1,a=new t,n=void 0,i=void 0,s=void 0,l=void 0,c=void 0,m=function(a){e||(c=a,u(),clearInterval(s),s=setInterval(u,3e4),e=!0)},u=function(){i=performance.timing.navigationStart+performance.now(),r.send({time:1}).then(d)},d=function(r){if(!r.error)if(e){clearInterval(l);var t=r.time,s=performance.timing.navigationStart+performance.now(),u=1e3*t+(s-i),d=function(){n=o(u+o().valueOf()-s).utc(),"function"==typeof c&&c()};d(),a.resolve(),l=setInterval(d,1e3)}else m()};return{init:m,get:function(){return n?n.clone():void 0},timePromise:a.promise}}();e.exports=i},"./src/javascript/_common/base/socket_base.js":
/*!****************************************************!*\
